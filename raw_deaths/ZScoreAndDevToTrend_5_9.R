...
data <- c(
  `2010` = 330, `2011` = 321, `2012` = 301, `2013` = 356, `2014` = 325,
  `2015` = 321, `2016` = 303, `2017` = 271, `2018` = 277, `2019` = 295,
  `2020` = 256, `2021` = 270, `2022` = 307, `2023` = 271
)
...
p <- ggplot(plot_data, aes(x = Year, y = Value, color = Type)) +
  ...
  theme_minimal() +
  labs(title = "France, Deaths among 5-9 years old, 2020 to 2023 compared to 2010-2019 Linear Trend", x = "Year", y = "Value") +
