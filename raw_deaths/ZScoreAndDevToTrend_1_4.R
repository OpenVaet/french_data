...
data <- c(
  `2010` = 525, `2011` = 500, `2012` = 534, `2013` = 539, `2014` = 492,
  `2015` = 505, `2016` = 481, `2017` = 455, `2018` = 466, `2019` = 479,
  `2020` = 380, `2021` = 415, `2022` = 452, `2023` = 451
)
...
p <- ggplot(plot_data, aes(x = Year, y = Value, color = Type)) +
  ...
  theme_minimal() +
  labs(title = "France, Deaths among 1-4 years old, 2020 to 2023 compared to 2010-2019 Linear Trend", x = "Year", y = "Value") +
