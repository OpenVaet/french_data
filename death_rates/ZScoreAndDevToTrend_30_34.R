...
data <- c(
`2010` = 0.676210612106789, `2011` = 0.648658069283179, `2012` = 0.631189773765104, `2013` = 0.618388909726449, `2014` = 0.614173204813564,
`2015` = 0.612656965352283, `2016` = 0.596130811583408, `2017` = 0.580157206663231, `2018` = 0.582069512678893, `2019` = 0.600688286553109,
`2020` = 0.590730055038074, `2021` = 0.59199109790861, `2022` = 0.61433507822796, `2023` = 0.589730606148952
)
...
p <- ggplot(plot_data, aes(x = Year, y = Value, color = Type)) +
  ...
  theme_minimal() +
  labs(title = "France, Deaths/1000 among 30-34 years old, 2020 to 2023 compared to 2010-2019 Linear Trend", x = "Year", y = "Value") +
