...
data <- c(
`2010` = 306.449548460499, `2011` = 296.2252273434, `2012` = 327.718109715796, `2013` = 323.42730299667, `2014` = 310.619074887065,
`2015` = 360.988859854215, `2016` = 336.533811769818, `2017` = 314.193369335199, `2018` = 309.162637339485, `2019` = 305.603611862761,
`2020` = 328.904493200125, `2021` = 314.397703181021, `2022` = 336.292771276879, `2023` = 319.153384549001
)
...
p <- ggplot(plot_data, aes(x = Year, y = Value, color = Type)) +
  ...
  theme_minimal() +
  labs(title = "France, Deaths/1000 among 95+ years old, 2020 to 2023 compared to 2010-2019 Linear Trend", x = "Year", y = "Value") +
