...
data <- c(
`2010` = 0.481831008956689, `2011` = 0.480233797627784, `2012` = 0.45541238613074, `2013` = 0.422581703254374, `2014` = 0.389422035667241,
`2015` = 0.402511108173511, `2016` = 0.39443343177313, `2017` = 0.402822681370843, `2018` = 0.400278724922247, `2019` = 0.373919293742115,
`2020` = 0.375866846313976, `2021` = 0.392561624831259, `2022` = 0.425261816626788, `2023` = 0.402748256339255
)
...
p <- ggplot(plot_data, aes(x = Year, y = Value, color = Type)) +
  ...
  theme_minimal() +
  labs(title = "France, Deaths/1000 among 20-24 years old, 2020 to 2023 compared to 2010-2019 Linear Trend", x = "Year", y = "Value") +
