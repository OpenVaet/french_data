...
data <- c(
`2010` = 1.5913700962756, `2011` = 1.53565303926645, `2012` = 1.48421072593578, `2013` = 1.45473706949341, `2014` = 1.35157661817443,
`2015` = 1.38261068201157, `2016` = 1.3070418824001, `2017` = 1.28806205448048, `2018` = 1.30626876565695, `2019` = 1.23996457673405,
`2020` = 1.27663802847947, `2021` = 1.29869453548918, `2022` = 1.33278108851734, `2023` = 1.2787060752341
)
...
p <- ggplot(plot_data, aes(x = Year, y = Value, color = Type)) +
  ...
  theme_minimal() +
  labs(title = "France, Deaths/1000 among 40-44 years old, 2020 to 2023 compared to 2010-2019 Linear Trend", x = "Year", y = "Value") +
