...
data <- c(
`2010` = 0.874504801609524, `2011` = 0.791686493179207, `2012` = 0.821573006828311, `2013` = 0.838781459139379, `2014` = 0.80276672917329,
`2015` = 0.828143477166116, `2016` = 0.814284156174434, `2017` = 0.836233552321209, `2018` = 0.847463433953628, `2019` = 0.84702816592142,
`2020` = 0.78045985913568, `2021` = 0.819552045906519, `2022` = 0.883112271086069, `2023` = 0.848038631214976
)
...
p <- ggplot(plot_data, aes(x = Year, y = Value, color = Type)) +
  ...
  theme_minimal() +
  labs(title = "France, Deaths/1000 among 0-4 years old, 2020 to 2023 compared to 2010-2019 Linear Trend", x = "Year", y = "Value") +
