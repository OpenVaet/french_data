...
data <- c(
`2010` = 16.7517473466218, `2011` = 16.0365146344334, `2012` = 16.3446988552591, `2013` = 16.4205737237177, `2014` = 15.7132036977353,
`2015` = 16.1245175259673, `2016` = 16.715783331918, `2017` = 16.3237250407698, `2018` = 16.0840142285418, `2019` = 15.9023560040961,
`2020` = 17.1211838470753, `2021` = 16.8070756395774, `2022` = 16.6512748399838, `2023` = 15.7292288739818
)
...
p <- ggplot(plot_data, aes(x = Year, y = Value, color = Type)) +
  ...
  theme_minimal() +
  labs(title = "France, Deaths/1000 among 70-74 years old, 2020 to 2023 compared to 2010-2019 Linear Trend", x = "Year", y = "Value") +
