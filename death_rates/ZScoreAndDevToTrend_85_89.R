...
data <- c(
`2010` = 95.8352330515905, `2011` = 91.3841128742294, `2012` = 95.1359739913824, `2013` = 93.039747454465, `2014` = 88.479440684725,
`2015` = 92.4404010955609, `2016` = 89.4791896892756, `2017` = 88.9246405560497, `2018` = 86.4735573616114, `2019` = 84.7760938372183,
`2020` = 91.7609492297292, `2021` = 87.3516728268658, `2022` = 87.4379842612975, `2023` = 80.9407517040039
)
...
p <- ggplot(plot_data, aes(x = Year, y = Value, color = Type)) +
  ...
  theme_minimal() +
  labs(title = "France, Deaths/1000 among 85-89 years old, 2020 to 2023 compared to 2010-2019 Linear Trend", x = "Year", y = "Value") +
