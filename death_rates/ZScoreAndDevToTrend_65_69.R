...
data <- c(
`2010` = 11.5380451495886, `2011` = 11.6104681633, `2012` = 11.6671383761084, `2013` = 11.4720052482457, `2014` = 11.0880336635296,
`2015` = 11.2638770728682, `2016` = 10.9306910147333, `2017` = 10.9747229285382, `2018` = 10.955327814664, `2019` = 10.877022629211,
`2020` = 11.4282028686918, `2021` = 11.7412930596768, `2022` = 11.5534389646249, `2023` = 11.0133021939531
)
...
p <- ggplot(plot_data, aes(x = Year, y = Value, color = Type)) +
  ...
  theme_minimal() +
  labs(title = "France, Deaths/1000 among 65-69 years old, 2020 to 2023 compared to 2010-2019 Linear Trend", x = "Year", y = "Value") +
