...
data <- c(
`2010` = 8.50977493732157, `2011` = 8.07072266862085, `2012` = 8.2047230317376, `2013` = 8.10850315800811, `2014` = 7.97688164849552,
`2015` = 8.02046387976968, `2016` = 8.13069674108813, `2017` = 8.08120609339075, `2018` = 7.95283512537184, `2019` = 7.79216530955281,
`2020` = 8.02703147766797, `2021` = 8.02045705631897, `2022` = 7.90023540282809, `2023` = 7.44430715575516
)
...
p <- ggplot(plot_data, aes(x = Year, y = Value, color = Type)) +
  ...
  theme_minimal() +
  labs(title = "France, Deaths/1000 among 60-64 years old, 2020 to 2023 compared to 2010-2019 Linear Trend", x = "Year", y = "Value") +
