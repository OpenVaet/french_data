...
data <- c(
`2010` = 1.00735934505188, `2011` = 0.959475185044977, `2012` = 0.89795289837637, `2013` = 0.884267066947694, `2014` = 0.874275180327164,
`2015` = 0.873433271100681, `2016` = 0.849996054128312, `2017` = 0.83902590128695, `2018` = 0.862408063357175, `2019` = 0.864501737381371,
`2020` = 0.824546827024352, `2021` = 0.864210497195233, `2022` = 0.896244962154723, `2023` = 0.881304706409195
)
...
p <- ggplot(plot_data, aes(x = Year, y = Value, color = Type)) +
  ...
  theme_minimal() +
  labs(title = "France, Deaths/1000 among 35-39 years old, 2020 to 2023 compared to 2010-2019 Linear Trend", x = "Year", y = "Value") +
