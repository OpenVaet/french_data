...
data <- c(
`2010` = 0.08492031386548, `2011` = 0.0828980325791851, `2012` = 0.0771648060804842, `2013` = 0.0906561288254149, `2014` = 0.0820310380207551,
`2015` = 0.0804641956889239, `2016` = 0.0755387747012417, `2017` = 0.067842859914508, `2018` = 0.0693353691732946, `2019` = 0.0742888729118846,
`2020` = 0.0648951967921493, `2021` = 0.0692903589394572, `2022` = 0.0797523779587288, `2023` = 0.0715420128490511
)
...
p <- ggplot(plot_data, aes(x = Year, y = Value, color = Type)) +
  ...
  theme_minimal() +
  labs(title = "France, Deaths/1000 among 5-9 years old, 2020 to 2023 compared to 2010-2019 Linear Trend", x = "Year", y = "Value") +
