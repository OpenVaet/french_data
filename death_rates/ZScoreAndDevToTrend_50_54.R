...
data <- c(
`2010` = 4.24018278208804, `2011` = 4.09455837263267, `2012` = 3.99141439873328, `2013` = 3.83064226056245, `2014` = 3.6371929741101,
`2015` = 3.61843940792625, `2016` = 3.44634858295909, `2017` = 3.45407005124719, `2018` = 3.39944438000873, `2019` = 3.34812551216146,
`2020` = 3.37066333471983, `2021` = 3.40618070020415, `2022` = 3.34811125702964, `2023` = 3.16361686904471
)
...
p <- ggplot(plot_data, aes(x = Year, y = Value, color = Type)) +
  ...
  theme_minimal() +
  labs(title = "France, Deaths/1000 among 50-54 years old, 2020 to 2023 compared to 2010-2019 Linear Trend", x = "Year", y = "Value") +
