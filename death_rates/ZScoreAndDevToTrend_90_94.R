...
data <- c(
`2010` = 192.702366734102, `2011` = 178.220990339605, `2012` = 182.507345165269, `2013` = 177.867078825348, `2014` = 168.773025992777,
`2015` = 174.05945251701, `2016` = 168.890051152557, `2017` = 168.212575749545, `2018` = 165.947196451144, `2019` = 164.468854763623,
`2020` = 179.38110664687, `2021` = 169.308356269262, `2022` = 173.731931322168, `2023` = 158.517090331952
)
...
p <- ggplot(plot_data, aes(x = Year, y = Value, color = Type)) +
  ...
  theme_minimal() +
  labs(title = "France, Deaths/1000 among 90-94 years old, 2020 to 2023 compared to 2010-2019 Linear Trend", x = "Year", y = "Value") +
