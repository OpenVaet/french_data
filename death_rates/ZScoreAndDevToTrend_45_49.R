...
data <- c(
`2010` = 2.60911968219428, `2011` = 2.48706743182461, `2012` = 2.45937467713753, `2013` = 2.38146785018402, `2014` = 2.29994727195119,
`2015` = 2.29486051410941, `2016` = 2.22076688763804, `2017` = 2.15861962233686, `2018` = 2.14507795352468, `2019` = 2.06783679200024,
`2020` = 2.09841368941701, `2021` = 2.0303223574662, `2022` = 2.0281703061056, `2023` = 1.93639593636212
)
...
p <- ggplot(plot_data, aes(x = Year, y = Value, color = Type)) +
  ...
  theme_minimal() +
  labs(title = "France, Deaths/1000 among 45-49 years old, 2020 to 2023 compared to 2010-2019 Linear Trend", x = "Year", y = "Value") +
