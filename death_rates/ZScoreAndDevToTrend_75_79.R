...
data <- c(
`2010` = 28.0615218253573, `2011` = 26.7484238785484, `2012` = 26.9430908709703, `2013` = 26.1105476534299, `2014` = 24.9434071568497,
`2015` = 25.677136469609, `2016` = 24.7575465766093, `2017` = 25.079668897825, `2018` = 24.9161571740141, `2019` = 24.4815230781058,
`2020` = 26.991591519526, `2021` = 27.7583018091792, `2022` = 26.9466267811391, `2023` = 25.092058586815
)
...
p <- ggplot(plot_data, aes(x = Year, y = Value, color = Type)) +
  ...
  theme_minimal() +
  labs(title = "France, Deaths/1000 among 75-79 years old, 2020 to 2023 compared to 2010-2019 Linear Trend", x = "Year", y = "Value") +
